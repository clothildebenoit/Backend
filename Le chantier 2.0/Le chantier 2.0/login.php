            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="images\chantier.jpg" alt="chantier"></figure>
                        <a href="inscription.php" class="signup-image-link">Je n'ai pas de compte</a>
                    </div>
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="register-form" id="login-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="your_name" id="your_name" placeholder="Prénom"/>
                            </div>
                            <div class="form-group">
